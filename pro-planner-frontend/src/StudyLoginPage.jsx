...
function StudyLoginPage(props) {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post("https://kmct-react-tutorial.onrender.com/login", { username, password });
  ...
  const handleRegister = async () => {
    try {
      const response = await axios.post("https://kmct-react-tutorial.onrender.com/register", { username, password });
